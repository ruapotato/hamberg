...
func _ready() -> void:
	...
	enemy_name = "Deer"
	max_health = 75.0  # Takes 4 axe hits, rewards patience
	health = max_health
...
func _setup_body() -> void:
	...
	back_left_leg.position = Vector3(-0.1 * scale_factor, 0.35 * scale_factor, -0.2 * scale_factor)
	...
	back_right_leg.position = Vector3(0.1 * scale_factor, 0.35 * scale_factor, -0.2 * scale_factor)
